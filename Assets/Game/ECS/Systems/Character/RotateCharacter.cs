...
{
    internal sealed class RotateCharacter : IEcsRunSystem
    {
        private readonly EcsFilterInject<Inc<Speed, CurrentTransform, MoveDirection, CharacterTag, MousePosition, MainCamera>, Exc<InactiveTag, DeadTag, CanMoveTag>> _filter;
